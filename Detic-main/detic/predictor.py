...
class VisualizationDemo(object):
    ...
    def run_on_image(self, image,output_path,image_path):
        """
        Args:
        ...
        if "panoptic_seg" in predictions:
            ...
            if "instances" in predictions:
                ...
                # print(instances)
                print(image_path)
                vis_output = visualizer.draw_instance_predictions(predictions=instances,output_path=output_path,image_path=image_path)
